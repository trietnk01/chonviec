			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="jp_newsletter_text">
						<img src="{{asset('public/frontend/job-light/images/content/news_logo.png')}}" class="img-responsive" alt="news_logo">
					</div>
				</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="jp_footer_logo_wrapper">
						<div class="jp_footer_logo">
							<a href="#"><img src="{{asset('public/frontend/job-light/images/content/resume_logo.png')}}" alt="footer_logo"></a>
						</div>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="jp_bottom_top_scrollbar_wrapper">
									<a href="javascript:" id="return-to-top" style="display: inline;"><i class="fa fa-angle-up"></i></a>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
