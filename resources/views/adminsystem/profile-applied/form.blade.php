...
$data_profile=App\ProfileModel::find((int)@$arrRowData['profile_id'])->toArray();
            ...
            <div class="form-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-9">                                   
                            <label class="control-label"><?php echo @$data_profile['fullname']; ?></label>                                              
                        </div>
                    </div>                         
                </div> 
                <?php 
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-9">                                   
                            <label class="control-label ribisachi-hp"><?php echo @$data_profile['career_goal']; ?></label>                                              
                        </div>
                    </div>                         
                </div>    
                <hr>    
                ...
                <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-9">                                   
                                <label class="control-label"><?php echo @$data_profile['other_software']; ?></label>                                              
                            </div>
                        </div>                         
                </div>    
                <div class="row">
                        <div class="form-group col-md-12">
                            <label class="col-md-3 control-label"><b>Thành tích nổi bật</b></label>
                            <div class="col-md-9">                                   
                                <label class="control-label ribisachi-hp"><?php echo @$data_profile['medal']; ?></label>                                              
                            </div>
                        </div>                         
                </div> 
                <hr>
                ...
                <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-9">                                   
                                <label class="control-label ribisachi-hp"><?php echo @$data_profile['hobby']; ?></label>                                              
                            </div>
                        </div>                         
                </div>
                <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-9">                                   
                                <label class="control-label ribisachi-hp"><?php echo @$data_profile['talent']; ?></label>                                              
                            </div>
                        </div>                         
                </div>   
                <div class="row"> 
